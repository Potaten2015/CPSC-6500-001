...
def rotation_matrix(xr, yr, zr):
    # Method can also be used to create orientation matrix

    x_rotation_radians = deg_2_rad(xr)
    y_rotation_radians = deg_2_rad(yr)
    z_rotation_radians = deg_2_rad(zr)
    ...
    total_rotation_matrix = x_rotation_matrix @ y_rotation_matrix @ z_rotation_matrix
...
if __name__ == '__main__':
    ...
    three_to_two_orientation = rotation_matrix(0, 0, 0)
    two_to_one_orientation = rotation_matrix(0, 0, 0)
    one_to_zero_orientation = rotation_matrix(-90, 0, 0)
    pprint(one_to_zero_orientation.round(decimals=5))
    three_rotation_matrix = rotation_matrix(0, 0, 0)
    two_rotation_matrix = rotation_matrix(0, 0, 60)
    one_rotation_matrix = rotation_matrix(0, 0, 30)
    zero_rotation_matrix = rotation_matrix(0, 0, 15)

    print(final_vector.round(decimals=4))
